...
1. Owner of `Love Story` and other songs from `Fearless` and the rest of her discography.
...
1. cr - chorus uniqueness ratio
2. lr - lexical uniqueness ratio

{% include ts_lyric_range.ratio.html %}
